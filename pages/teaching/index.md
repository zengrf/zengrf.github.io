...
<section class="section">
  ...
  <p>In Spring 2024, I co-organized a graduate reading course on intersection theory together with <a href="https://sites.google.com/view/arkamouli/courses-and-research?authuser=0">Arkamouli Debnath</a>, supervised by <a href="https://math.washington.edu/people/sandor-kovacs">Sándor Kovács</a>. Notes and schedule can be found at the course website <a href="https://sites.google.com/view/uwmath583cintersectiontheory">MATH 583C Intersection Theory</a>.</p>
</section>
...
<section class="section">
  ...
  <ul>
    <li>(FL25) <i>TA,</i> MATH208: Linear Algebra</li>
  </ul>

  <h3>2024 &ndash; 2025</h3>
  <ul>
    <li>(SP25) <i>Grader,</i> MATH327: Introduction to Real Analysis</li>
    <li>(WI25) <i>TA,</i> MATH 111: Algebra with Applications</li>
    <li>(AU24) <i>TA,</i> MATH 126 CE / CF: Calculus with Analytic Geometry III</li>
  </ul>

  <h3>2023 &ndash; 2024</h3>
  <ul>
    <li>(SU24) <i>Grader,</i> MATH 300 A: Introduction to Mathematical Reasoning</li>
    <li>(SP24) <i>TA,</i> MATH 126 BA / BB: Calculus with Analytic Geometry III</li>
    <li>(WI24) <i>TA,</i> MATH 125 CC / CD: Calculus with Analytic Geometry II</li>
    <li>(AU23) <i>TA,</i> MATH 125 CE / CF: Calculus with Analytic Geometry II</li>
  </ul>
</section>
...
<section class="section">
  ...
  <figure>
    <img src="{{ '/assets/img/circle-of-apollonius-slide.png' | relative_url }}" alt="Intersection theory seminar discussion" />
  ...
  <div style="display: flex; gap: 1.5rem; align-items: flex-start; justify-content: center; margin: 2rem 0;">
    <figure style="margin: 0; height: 150px; border-radius: 4px; box-shadow: var(--shadow); overflow: hidden;">
      <img src="{{ '/assets/img/27LinesPrint.png' | relative_url }}" alt="3D printed 27 lines structure" style="height: 100%; width: auto; object-fit: contain; display: block;" />
    </figure>
    <figure style="margin: 0; height: 150px; border-radius: 4px; box-shadow: var(--shadow); overflow: hidden;">
      <img src="{{ '/assets/img/HeartPrint.png' | relative_url }}" alt="3D printed heart shape" style="height: 100%; width: auto; object-fit: contain; display: block;" />
    </figure>
  </div>
  ...
  <ul>
    ...
    <li>(SP24) Enumerative Geometry, Incidence Geometry, Projective Geometry</li>
